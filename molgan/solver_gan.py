...
class Solver(object):
    ...
    def train_or_valid(self, epoch_i, train_val_test='val'):
        ...
        for a_step in range(the_step):
            ...
            #print("Input shapes - a_tensor: {}, x_tensor: {}".format(a_tensor.shape, x_tensor.shape))
            #print("Output shape - value_logit_real: {}".format(value_logit_real.shape))
            
            
            value_logit_fake, _ = self.V(edges_hat, None, nodes_hat, torch.sigmoid)
            #print("Input shapes - edges_hat: {}, nodes_hat: {}".format(edges_hat.shape, nodes_hat.shape))
            #print("Output shape - value_logit_fake: {}".format(value_logit_fake.shape))
