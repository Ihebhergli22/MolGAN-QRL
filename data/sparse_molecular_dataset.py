...
if __name__ == '__main__':
    ...
    # QM9 sample dataset
    # data = SparseMolecularDataset()
    # data.generate('gdb9_sample.sdf', filters=lambda x: x.GetNumAtoms() <= 9)
    # data.save('gdb9_sample.sparsedataset')
     
    # GDB9 sample dataset
     data = SparseMolecularDataset()
     data.generate('qm9_sample.smi', filters=lambda x: x.GetNumAtoms() <= 9)
     data.save('qm9_sample.sparsedataset')
