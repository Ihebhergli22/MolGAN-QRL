...
def get_GAN_config():
    ...
    #New Samples = Same molecules, different forms : SDF (gdb9) vs SMILES (qm9)
    #parser.add_argument('--mol_data_dir', type=str, default='data/qm9_sample.sparsedataset')
    #parser.add_argument('--mol_data_dir', type=str, default='data/gdb9_sample.sparsedataset')
    #parser.add_argument('--mol_data_dir', type=str, default='data/qm9_3dob_sample.sparsedataset')
    
    #EXPERIMENTS
    #parser.add_argument('--mol_data_dir', type=str, default='data/gdb9_9nodes.sparsedataset') #SDF ORIGINAL
    parser.add_argument('--mol_data_dir', type=str, default='data/qm9_smiles.sparsedataset') #SMILES ORIGINAL
    #parser.add_argument('--mol_data_dir', type=str, default='data/qm9_3dob.sparsedataset') #SDF FROM SMILES WITH OB

    # Directories.
    parser.add_argument('--saving_dir', type=str, default='./Results/quantum_GAN/')
